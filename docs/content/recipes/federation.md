...
server in gqlgen. You can find the finished result in the [examples directory](https://github.com/vndocker/encrypted-graphql/tree/master/example/federation).
...
```bash
go run github.com/vndocker/encrypted-graphql
```
