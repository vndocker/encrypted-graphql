...
$ go get github.com/LaBanHSPO/gqlgen
```
...
```bash
$ go run github.com/LaBanHSPO/gqlgen init
```
...
And run `go run github.com/LaBanHSPO/gqlgen generate`.
...
```go
//go:generate go run github.com/LaBanHSPO/gqlgen
```
