...
$ go get github.com/vndocker/encrypted-graphql
```
...
```bash
$ go run github.com/vndocker/encrypted-graphql init
```
...
And run `go run github.com/vndocker/encrypted-graphql generate`.
...
```go
//go:generate go run github.com/vndocker/encrypted-graphql
```
